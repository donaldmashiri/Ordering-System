		...
		<div class="container">
			<div class="row">
				<div class="col-md-4 order-1">
					<img src="vegetables1.jpg" width="100" alt=""
			...
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item active font-weight-bold"
						aria-current="page">vegetables</li>
				</ol>
			</nav>
			<div class="row mt-3">
				<%
				try {
						...
						String sql = "SELECT * FROM fooddetails WHERE category = 'vegetables'";
				...
				<div class="col-md-4 mb-3">
					<ul class="list-group">
						<li class="list-group-item"><img src="vegetables1.jpg"
